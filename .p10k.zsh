# Generated by Powerlevel10k configuration wizard on 2020-12-16 at 10:08 CET.
...
() {
  ...
  POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON=${(g::)POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON}
  typeset -g POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON='\uF01B '
  POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON=${(g::)POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON}
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}⇣${POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON}${VCS_STATUS_COMMITS_BEHIND}"
    # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
    (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON}${VCS_STATUS_COMMITS_AHEAD}"
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}${POWERLEVEL9K_VCS_STASHED_ICON}${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}~${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${POWERLEVEL9K_VCS_STAGED_ICON}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${POWERLEVEL9K_VCS_UNSTAGED_ICON}"
